...
export const metadata = {
  ...
  description: 'The Human Factor is a system improvement and AI integration firm based in Waterloo, Ontario, backed by research partnerships with the University of Waterloo and Western University.',
}
    ...
    <>
      <section className="pt-32 pb-16 px-6 text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">The Human Side of System Improvement</h1>
          <p className="text-lg text-slate-400 max-w-2xl">We believe the best system improvements start with people — understanding how they work, where systems support or hinder them, and how technology can amplify rather than replace expert judgment.</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="space-y-4 text-slate-400">
                <p>The Human Factor is a system improvement and AI integration firm based in Waterloo, Ontario. We bring together researchers and practitioners from the University of Waterloo&apos;s Systems Design Engineering and Human Factors programs and Western University&apos;s Computer Science and Digital Security departments.</p>
                <p>Unlike technology vendors who start with a product and look for a problem, we start with the humans doing the work. Our methodology draws on established frameworks from Human Factors Engineering, Cognitive Systems Engineering, healthcare quality improvement, and evidence-based change management.</p>
                <p>We serve organizations across North America — from healthcare and emergency services to professional services and manufacturing — anywhere human performance, system reliability, and safety intersect.</p>
              </div>
            </div>
            <div className="card p-8">
              <h3 className="text-lg font-bold mb-6 text-white">Our Principles</h3>
      ...
      <section className="section-pad section-elevated">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-400 mb-8 max-w-2xl">AI Readiness & Implementation Approach — a structured methodology built on established frameworks from Human Factors Engineering, healthcare quality improvement, and organizational science.</p>
      ...
      <section className="section-pad section-dark">
        <div className="max-w-4xl mx-auto">
          <p className="eyebrow">Agency Associates & Partners</p>
          <h2 className="text-3xl font-bold mb-4 text-white">Research-Backed Implementation</h2>
          <p className="text-slate-400 mb-12 max-w-2xl">Our team draws from active researchers and practitioners at leading Canadian institutions, giving our clients direct access to cutting-edge research translated into practical system improvement.</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-2xl font-bold mb-4 text-white">Custom Tools & Workflow Systems</h2>
              <div className="space-y-4 text-slate-400">
                <p>Beyond assessment, we design and build custom AI tools and workflow systems. Our engineering team creates purpose-built solutions using modern cloud and open-source infrastructure — tools fitted to your work, not the other way around.</p>
              </div>
            </div>
      ...
      <section className="section-pad section-elevated">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-4 text-white">Curious where your organization stands?</h2>
          <p className="text-slate-400 mb-8">Take our free AI Readiness Assessment and get a personalized report with actionable recommendations across 6 dimensions.</p>
