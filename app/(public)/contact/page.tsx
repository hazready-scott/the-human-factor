...
export const metadata = {
  ...
  description: 'Get in touch with The Human Factor for system improvement, AI integration, and quality improvement. Based in Hamilton, Ontario.',
}
            ...
            <div>
              ...
              <div className="space-y-6 text-slate-400">
                ...
                <div>
                  ...
                  <a href="mailto:info@thehumanfactor.ca" className="text-[#c9944a] hover:text-[#c9944a]-dark transition-colors">info@thehumanfactor.ca</a>
                </div>
                <div>
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/sdramey" target="_blank" rel="noopener noreferrer" className="text-[#c9944a] hover:text-[#c9944a]-dark transition-colors text-sm">LinkedIn &rarr;</a>
                </div>
                <div>
                  <h3 className="font-semibold mb-2 text-white">What to Expect</h3>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2"><span className="text-[#c9944a] mt-0.5">&#10003;</span>Response within 24 hours</li>
                    <li className="flex items-start gap-2"><span className="text-[#c9944a] mt-0.5">&#10003;</span>Free initial conversation</li>
                    <li className="flex items-start gap-2"><span className="text-[#c9944a] mt-0.5">&#10003;</span>No-obligation assessment review</li>
                  </ul>
                </div>
              </div>
            </div>
