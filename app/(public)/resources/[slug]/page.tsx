    ...
    <>
      <section className="pt-32 pb-12 px-6 bg-hero-gradient text-white">
        <div className="max-w-3xl mx-auto">
          <Link href="/resources" className="text-sm text-slate-400 hover:text-white transition-colors mb-4 inline-block">
      ...
      {article.cover_image_url && (
        <div className="max-w-4xl mx-auto px-6 -mt-6">
          <img src={article.cover_image_url} alt="" className="w-full h-64 md:h-96 object-cover rounded-xl" />
        </div>
      )}
      ...
      <section className="section-pad">
        <div className="max-w-3xl mx-auto">
          <div
            className="prose prose-slate prose-lg max-w-none prose-headings:text-[#0f172a] prose-a:text-[#06b6d4] prose-a:no-underline hover:prose-a:underline"
